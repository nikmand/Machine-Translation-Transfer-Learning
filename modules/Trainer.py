...
class Trainer:
    ...
    """
    def __init__(self, model, train_loader=None, valid_loader=None,
                 criterion=None,
                 optimizers=None, config=None, device='cpu',
    ...
    def return_tensor_and_list(self, batch_losses, weights=None):
        """
    ...
    def train_epoch(self):
        ...
        * This will be a pessimistic approximation of the true loss
        ...
        for i_batch, batch in enumerate(iterator, 1):
            ...
            loss_sum, loss_list = self.return_tensor_and_list(batch_losses)
